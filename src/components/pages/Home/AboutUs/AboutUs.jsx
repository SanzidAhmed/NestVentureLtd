...
const AboutUs = () => {
  ...
  return (
    <div className="bg-white">
      <div className="container max-w-[1320px] mx-auto my-24 bg-white">
        {about.map((company) => (
          <div
            key={company.id}
            className="md:flex p-6 md:p-0 gap-6 items-center"
          >
            <div className="w-full">
              ...
              <div className="flex  gap-4 mt-5">
                <div className="relative">
                  <FaChartLine className="absolute left-2 top-2 text-4xl"></FaChartLine>
              ...
              <div className="flex  gap-4 mt-5">
                <div className="relative">
                  <FaPeopleGroup className="absolute left-2 top-2 text-4xl"></FaPeopleGroup>
                  <h1 className="text-2xl p-6 bg-red-300 rounded-full"></h1>
                </div>
                <div>
                  <h2 className="text-3xl font-semibold mb-3">
